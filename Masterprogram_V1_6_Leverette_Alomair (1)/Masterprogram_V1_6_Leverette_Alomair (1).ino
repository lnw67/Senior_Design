...
#define RedVictim 51
#define YellowVictim 49
#define SecondToMain 47
#define MainToSecond 45
...
void loop()
{
  ...
  digitalWrite(MainToSecond,HIGH);
   ...
   //Do while to wait for second arduino.
    do 
    {
     ...
     while( digitalRead(SecondToMain) == LOW ); 
...
// Point F to E
 void fnGofe() //VERIFIED
  {
    fnGyroTurn(left90 - 300);
    iTemp5 = fnIRRead(100);
    delay(TurnDelay);
    analogWrite(S1,REV);
    delay(1000);
...
int fnIRRead(int iSMCMD)
{
  ...
  delay(20);  //delay added for accuracy (1.3)

  iTemp4 = analogRead(A2);
  delay(20);
  iTemp5 = analogRead(A2);

  if(iTemp4 - iTemp5 > 500)
  {
    return iTemp5;
  }
  if(iTemp5 - iTemp4 > 500)
  {
    return iTemp4;
  }
  else
  {
  iTemp5 = iTemp5 + iTemp4;
  iTemp4 = iTemp5/2;
  return iTemp4;
  }
